...
fn test_string_literals() {
    ...
    let expected_tokens = vec![
        ...
        Token::new(
            TokenType::String("world 123".to_string()),
            "\"world 123\"".to_string(),
            Span::new(8, 19),
        ),
        Token::new(
...
"#;
    ...
    let expected_tokens = vec![
        ...
        Token::new(
            TokenType::Identifier("counter".to_string()),
            "counter".to_string(),
            Span::new(57, 64),
        ),
        ...
        Token::new(TokenType::KeywordInt, "int".to_string(), Span::new(83, 86)),
        Token::new(TokenType::CloseParen, ")".to_string(), Span::new(86, 87)),
        Token::new(TokenType::Colon, ":".to_string(), Span::new(87, 88)),
        Token::new(TokenType::KeywordInt, "int".to_string(), Span::new(89, 92)),
        ...
        Token::new(
            TokenType::Identifier("increment".to_string()),
            "increment".to_string(),
            Span::new(146, 155),
        ),
        ...
        Token::new(
            TokenType::String("zero".to_string()),
            "\"zero\"".to_string(),
            Span::new(217, 223),
        ),
        ...
        Token::new(
            TokenType::String("not zero".to_string()),
            "\"not zero\"".to_string(),
            Span::new(234, 244),
        ),
        ...
        Token::new(
            TokenType::Identifier("my_list".to_string()),
            "my_list".to_string(),
            Span::new(249, 256),
        ),
